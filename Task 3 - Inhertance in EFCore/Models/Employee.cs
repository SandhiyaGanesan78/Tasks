...
public class Employee{
    ...
    [RegularExpression(@"^[6-9]\d{9}$", ErrorMessage = "Please enter a valid 10-digit mobile number starting with 6, 7, 8, or 9.")]
    [DisplayName("Enter employee mobile number")]
    ...
    [DataType(DataType.Date)]
    [DisplayFormat(ApplyFormatInEditMode = true, DataFormatString = "{0:yyyy-MM-dd}", NullDisplayText = "Enter employee date of birth")]
    [DisplayName("Set employee DoB")]
